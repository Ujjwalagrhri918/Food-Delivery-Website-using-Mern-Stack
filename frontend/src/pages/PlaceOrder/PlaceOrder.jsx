...
const PlaceOrder = () => {
  ...
  // below when data is entered onchangehandler is triggered which sets the value
  // for the name = firstName with the value obtained in the input field and 
  // save using setData
  return (
    ...
    <form onSubmit={placeOrder} className='place-order'>
      <div className="place-order-left">
        ...
        <input name="email" required onChange={onChangeHandler} value={data.email}type="email" placeholder='Email Adress' />
        ...
        <div className="multi-fields">
          ...
          <input name="state"required  onChange={onChangeHandler} value={data.state}type="text" placeholder='States' />
        </div>
        <div className="multi-fields">
        ...
        <input name="phone" required  onChange={onChangeHandler} value={data.phone} type='text' placeholder='phone'></input>
      </div>
